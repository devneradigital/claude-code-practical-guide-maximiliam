...
- **AVOID** `useEffect()`
  - See the ["You Might Not Need An Effect" guide](/claude/skills/modern-best-practice-react-components/references/you-dont-need-useeffect.md) for detailed guidance
